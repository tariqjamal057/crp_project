...
from .admin_views import (
    ...
    download_vendor_statement_pdf, download_ap_aging_excel, download_ap_aging_pdf,
...
urlpatterns = [
    ...
    path(
        f'admin-reports/vendor-statement/<{party_pk_converter}>/pdf/',  # Use the correct pk converter for supplier_pk
        download_vendor_statement_pdf,  # This is the function defined in this urls_api.py file
        name='download_vendor_statement_pdf' # This name must match the template's {% url %} tag
    ),
    path('admin-reports/ap-aging/', admin_ap_aging_report_view, name='admin-view-ap-aging'),
    path('admin-reports/ap-aging/excel/', download_ap_aging_excel, name='admin-download-ap-aging-excel'), # Assuming download_ap_aging_excel is correctly mapped
    path('admin-reports/ap-aging/pdf/', download_ap_aging_pdf, name='admin-download-ap-aging-pdf'),       # Assuming download_ap_aging_pdf is correctly mapped
